<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/user') ?>">User</a></li> <li class="breadcrumb-item active"><?php echo $title ?></li>
        </ol>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="role" name="role" required> <option selected>Choose...</option>
                        <option value="admin">ADMIN</option> <option value="sekretaris">SEKRETARIS</option>
                    </select>
                </div>

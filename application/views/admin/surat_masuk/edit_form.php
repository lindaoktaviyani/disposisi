        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="<?php echo site_url('admin/surat_masuk/edit') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="username">KETERANGAN <code>*</code></label><textarea class="form-control" placeholder="KETERANGAN" name="keterangan" id="floatingTextarea2" style="height: 100px"><?= $surat->keterangan; ?> </textarea>
                    </div>
                    <div class="mb-3">

    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item">
                <a href="<?php echo site_url('admin/surat_masuk') ?>">User</a>
            </li>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div class="mb-3">
                    <label >TANGGAL SURAT <code>*</code></label> <input class="form-control" type="date" name="tgl_surat" placeholder="TANGGAL SURAT" required />
                </div>
                <div class="mb-3">
